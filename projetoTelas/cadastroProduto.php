                                        ...
                                        <tr>    
                                            ...
                                            <td> 
                                                <button type="button" onclick="carregaModal('<?php echo $key['descricao']; ?>',
                                                                                            ...
                                                                                            <?php echo $key['idproduto']; ?>)" data-target=".bd-example-modal-lg" data-toggle="modal" id="btn-editar" class="btn btn-primary"  >
                                                    <img id="editar" src="img/icons8-editar-26.png"> 
                                                </button>

                                                <button type="button" id="btn-editar" class="btn btn-primary" data-toggle="modal">
                                                    <a href="../Class/produto.controller.php?acao=deletar"> <img id="editar" src="img/icons8-excluir-26.png">
                                                </button>
                                                        </td> 
                                                        ...
                                                        <div class="modal-dialog modal-lg">
                                                            <div class="modal-content">
                                                                <div class="container">
                                                                    ...
                                                                    <form class="form-horizontal" action="../Class/produto.controller.php?acao=alterar" method="post" >
                                                                        <fieldset>
                                                                            <div class="panel panel-primary">
                                                                                </br>
                                                                                ...
                                                                                <div class="panel-body">
                                                                                    ...
                                                                                    <div class="form-row">
                                                                                        <div class="form-group col-md-4">
                                                                                            <label for="numeracao">Numeração <h11>*</h11></label>
                                                                                            <select id="numeracaoModal" name="numeracao" class="form-control" required="" >
                                                                                                <option selected>Escolher...</option>
                                                                                                <option value="27">27</option>
                                                                                                <option value="28">28</option>
                                                                                                <option value="29">29</option>
                                                                                        ...
                                                                                        <div class="form-group col-md-4">
                                                                                            <label for="cor">Cor <h11>*</h11></label>
                                                                                            <select id="corModal" name="cor" class="form-control">
                                                                                                <option selected>Escolher...</option>
                                                                                                <option>Amarelo</option>
                                                                                                <option>Azul</option>
                                                                                                <option>Azul Marinho</option>
                                                                                    ...
                                                                                    <div class="form-row">
                                                                                        <div class="form-group col-md-4">
                                                                                            ...
                                                                                            <label class="radio-inline" for="radios-0" >
                                                                                                <input name="genero" id="sexoModalF"  type="radio">
                                                                                                Feminino
                                                                                            </label>
                                                                                            <label class="radio-inline" for="radios-1">
                                                                                                <input name="genero" id="sexoModalM"  type="radio">
                                                                                                Masculino
                                                                                            </label>
                                                                                        </div>
                                                                                        <div class="form-group col-md-4">
                                                                                            <label for="marca">Marca <h11>*</h11></label>
                                                                                            <select id="marcaModal" name="marca" class="form-control">
                                                                                                <option selected>Escolher...</option>
                                                                                                <option>Adora</option>
                                                                                                <option>Ana Flex</option>
                                                                                                <option>Avenue</option>
                                                                                    ...
                                                                                    <div class="form-row">
                                                                                        <div class="form-group col-md-4">
                                                                                            <label for="valorunit">Valor unitário <h11>*</h11></label>
                                                                                            <input id="valorunitModal" name="valorUnitario" class="form-control" required="" placeholder="R$ " type="text" maxlength="15" OnKeyPress="formatar('## ###,###,##', this)">
                                                                                        </div>
                                                                                        <div class="form-group col-md-4">
                                                                                            <label for="saldoprod">Saldo do produto</label>
                                                                                            <input id="saldoprodModal" name="saldoProduto" class="form-control" type="text">
                                                                                        </div>
                                                                                    </div>
                                                                                    </br>
                                                                                    ...
                                                                                    <div class="text-center">
                                                                                        ...
                                                                                        <button id="Alterar" type="submit" name="Alterar" class="btn btn-warning">
                                                                                            <a href="../Class/produto.controller.php?acao=editar" id="linkEditarModal">Atualizar</button>
